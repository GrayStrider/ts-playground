 ...
 * ProxyCustom. As long as the client works with RealSubject using this interface,
 ...
 * e.g. correcting input data. A ProxyCustom can solve these issues without any
