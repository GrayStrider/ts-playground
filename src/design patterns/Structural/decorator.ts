/**
 * The base ComponentComposite interface defines operations that can be altered by
 * decorators.
 */
...
/**
 * The client code works with all objects using the ComponentComposite interface. This
